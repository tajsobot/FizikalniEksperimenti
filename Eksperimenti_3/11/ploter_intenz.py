...
filenames = ["meritve/ref.csv", "meritve/3B1layer.csv", "meritve/3B2layer.csv","meritve/3B3layer.csv","meritve/3B4layer.csv","meritve/3B5layer.csv"]
...
for idx, filename in enumerate(filenames):
    try:
        ...
        ax.errorbar(
            ...
            linestyle='none',
            label=filename.split('/')[-1]  # Use just filename as label
        )
